...
// OVERLAY COLORS
const kTopRightOverlayColor = Color(0xff0A3C47);
const kBottomLeftOverlayColor = Color(0xff326045);
...
const kGreenGlowColor = Color(0xff91DC9C);

// Triangle Nav Colors
const Color kGreenGradientStart = Color(0xff6DFB8D);
const Color kGreenGradientMiddle = Color(0xff67FF89);
const Color kGreenGradientEnd = Color(0xffABF5BA);
const Color kGreenGradientSecondary = Color(0xff9CFCB0);
const Color kGreenGradientHighlight = Color(0xff67FE85);
const Color kDarkGreen = Color(0xff3B5F43);
const Color kLightGreen = Color(0xffD3FCDD);
const Color kDarkGray = Color(0xff5D7562);
const Color kGlowingText = Colors.greenAccent;
const Color kGlowingTextColor = Color(0xff7ef39b);
const Color kTextDefaultColor = Color(0xff4E5A54);
